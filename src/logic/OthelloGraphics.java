...
public class OthelloGraphics extends Application{
  ...
  public void drawVictoryScreen() {
    ...
    if (board.turnScore("1") > board.turnScore("2")) {
      ...
      winnerMessage = new Label("It's a draw!");
    }
  ...
  public void initPlayerNames(){
    ...
    NumberBinding nameCoord1 = p1name.layoutXProperty().add(p1name.widthProperty().add(10));
    ...
    NumberBinding nameCoord2 = p2name.layoutXProperty().add(p2name.widthProperty().add(10));
    ...
    NumberBinding nameCoord3 = pname.layoutXProperty().add(pname.widthProperty().add(10));
