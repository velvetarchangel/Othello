...
import logic.Board;
import logic.Player;
import text.OthelloHelper;

/**
 * this class runs the text based version of the game using other classes in the
 * background the text based version is able to quit the game at any point, run
 * a mode for player vs player and run a mode for player vs AI
 * 
